...
class CourseClass:
    def __init__(self,root):
        ...
        # ===============Widgets===================
        lbl_coursename = Label(self.root, text="Course Name", font=("goudy old style", 15, "bold"), bg="white").place(x=10,
                                                                                                                  y=60)
        ...
        self.txt_description.place(x=150, y=180, width=470, height=130)
        ...
        lbl_search_course = Label(self.root, text="Course Name", font=("goudy old style", 15, "bold"), bg="White")
        lbl_search_course.place(x=680, y=60, width=200)
        ...
        try:
            if self.var_course.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success", "Course Added Successfuly", parent=self.root)
                    self.show()
        except EXCEPTION as ex:
            messagebox.showerror("Error",f"Error due to {str(ex)}")
        ...
        try:
            if self.var_course.get() == "":
                ...
                if row == None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success", "Course Update Successfuly", parent=self.root)
                    self.show()
        except Exception as ex:
            messagebox.showerror("Error", f"Error Due To {str(ex)}")
